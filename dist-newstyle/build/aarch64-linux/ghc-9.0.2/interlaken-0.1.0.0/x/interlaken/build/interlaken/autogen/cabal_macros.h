...
/* package interlaken-0.1.0.0 */
#ifndef VERSION_interlaken
#define VERSION_interlaken "0.1.0.0"
#endif /* VERSION_interlaken */
#ifndef MIN_VERSION_interlaken
#define MIN_VERSION_interlaken(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_interlaken */
...
#define CURRENT_COMPONENT_ID "interlaken-0.1.0.0-inplace-interlaken"
